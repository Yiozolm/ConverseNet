...
def main():
    ...
    from models.converse_srresnet import ConverseMSRResNet as net
    model = net(in_channels=n_channels, out_channels=n_channels, num_features=64, num_blocks=16, upscale=4)
