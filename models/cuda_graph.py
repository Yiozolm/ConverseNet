...
class USRNetCUDAGraph:
    ...
    Set enabled=False to call the model directly, preserving autograd and CPU
    execution under the model's FP32 contract. Switching off also clears captured
    graphs. Explicit construction defaults to enabled=True for compatibility;
    model(...) itself never enables CUDA Graphs.
