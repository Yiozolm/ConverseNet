...
std::vector<at::Tensor> shared_s1_forward_cuda(const at::Tensor& fy,const at::Tensor& fk,const at::Tensor& lambda) {
...
std::vector<at::Tensor> shared_s1_backward_cuda(const at::Tensor& grad,const at::Tensor& fy,const at::Tensor& fk,
